...
default_categories_961 = [
  {
    "Id": 1,
    "CategoryName": "PCI DSS (3.1) - 6.5.1 - Injection flaws - particularly SQL injection",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 2,
    "CategoryName": "PCI DSS (3.1) - 6.5.2 - Buffer overflows",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 3,
    "CategoryName": "PCI DSS (3.1) - 6.5.3 - Insecure cryptographic storage",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 4,
    "CategoryName": "PCI DSS (3.1) - 6.5.4 - Insecure communications",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 5,
    "CategoryName": "PCI DSS (3.1) - 6.5.5 - Improper error handling",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 6,
    "CategoryName": "PCI DSS (3.1) - 6.5.7 - Cross-site scripting (XSS)",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 7,
    "CategoryName": "PCI DSS (3.1) - 6.5.8 - Improper access control",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 8,
    "CategoryName": "PCI DSS (3.1) - 6.5.9 - Cross-site request forgery",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 9,
    "CategoryName": "PCI DSS (3.1) - 6.5.10 - Broken authentication and session management",
    "CategoryType": {
      "Id": 1,
      "Name": "PCI DSS v3.1",
       "Order": 99999
  ...
  {
    "Id": 425,
    "CategoryName": "PCI DSS (4.0) - 6.2.4 Vulnerabilities in software development",
    "CategoryType": {
      "Id": 20,
      "Name": "PCI DSS v4.0",
       "Order": 35
